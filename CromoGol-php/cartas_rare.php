...
<head>
    ...
    <title>Cartas Rare - CromoGol</title>
    <link rel="stylesheet" href="CromoGol-css/CromoGol.css">
    <link rel="stylesheet" href="CromoGol-css/cartas-rare.css">
</head>
<body>
    <header>
        <div class="logo">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            fetch('obtener_cartas.php?tipo=Rare')
                ...
                .then(data => {
                    ...
                    if (data.length > 0) {
                        ...
                        catalogoCartas.innerHTML = '<p>No hay cartas rare disponibles.</p>';
                    }
                })
                .catch(error => {
